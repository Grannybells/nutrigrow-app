...
import sili from "../images/sili.png";
import okra from "../images/okra.png";
...
const Plants = () => {
    ...
    const bellpepper = require('../images/bellpepper.png');
    const lettuce = require('../images/lettuce.png');
    const sili = require('../images/sili.png');
    const okra = require('../images/okra.png');
    const ginger = require('../images/ginger.png');
    const pechay = require('../images/pechay.png');
    const garlic = require('../images/garlic.png');
    const kale = require('../images/kale.png');
    const cauli = require('../images/cauli.png');
