import { StyleSheet, Text, View, Image, StatusBar, ScrollView, SafeAreaView } from "react-native";
            ...
            <ScrollView style={styles.body}>
                ...
                <View style={styles.dataContainer}>
                    ...
                    <View style={styles.parameter}>
                        ...
                        <Text style={styles.subTextCard}>{sensorData.status.p_level}</Text>
                    </View>
                ...
                <View style={styles.dataContainer2}>
                    ...
                    <View style={styles.parameterContainer}>
                        ...
                        <View style={styles.dataWater}>
                            <Text style={styles.dataText}>{sensorData.sensor.moisuture}%</Text>
                ...
                <View style={styles.plantContainer}>
                    ...
                    <Text style={styles.headerText}>{sensorData.recommendation.new_nitrogen}     {sensorData.recommendation.new_phosphorus}     {sensorData.recommendation.new_potassium}</Text>
                </View>
            </ScrollView>
        </SafeAreaView>
    );
